...
bool b_stage_akasztas, b_stage_keseles, b_stage_happyending, b_stage_asthma, b_stage_denial;
bool dia[20];
Uint8 darkness;
int toLeft = 0;
int startTime;
...
void loadTextsStage_denial()
{
    if (!textBoxtext1.loadFromRenderedText("PRINCCESS: I've had enough! I don't need you! ", { 255, 153, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext2.loadFromRenderedText("I rather rot in this mine alone!", { 255, 153, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext3.loadFromRenderedText("Miner! get this fool out of this place! ", { 255, 153, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext4.loadFromRenderedText("Even if he will be hanged!", { 255, 153, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    textTransition1 = { 0, 0, 0, 15 };
...
void loadTextsStage_happy3()
{
    if (!textBoxtext1.loadFromRenderedText("You managed to escape the mine,", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext2.loadFromRenderedText("and lived happily ever after with the reward", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext3.loadFromRenderedText("you got from the emperor (press any key to exit)", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    textTransition1 = { 0, 0, 0, 15 };
...
void loadTextsStage_happy2()
{
    if (!textBoxtext1.loadFromRenderedText("After you killed the emperor, you became", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext2.loadFromRenderedText("the leader of the Assyrian Empire with", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext3.loadFromRenderedText("the princess on your side(press any key to exit)", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    textTransition1 = { 0, 0, 0, 15 };
...
void loadTextsStage_happy1()
{
    if (!textBoxtext1.loadFromRenderedText("After you married to the princess", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext2.loadFromRenderedText("you lived happily ever after with 17 kids...", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext3.loadFromRenderedText("(press any key to exit)", { 255, 255, 255 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    textTransition1 = { 0, 0, 0, 15 };
...
void loadTextsStage_asthma()
{
    if (!textBoxtext1.loadFromRenderedText("You have chosen a path which was too polluted.", { 200, 200, 200 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext2.loadFromRenderedText("You die because of your severe asthma...", { 200, 200, 200 }, textFont))
    {
        std::cout << TTF_GetError() << "\n";
    }
    if (!textBoxtext3.loadFromRenderedText("(press any key to restart)", { 200, 200, 200 }, textFont))
